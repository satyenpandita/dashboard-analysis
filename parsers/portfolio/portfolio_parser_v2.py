            ...
            if val and val != "":
                ...
                if ticker:
                    folio[ticker] = (cell_value(worksheet, target_row, target_col + 5),
                                     ...
                                     cell_value(worksheet, target_row, target_col + 15) if cell_value(worksheet, target_row, target_col + 15) != "" else None,
                                     cell_value(worksheet, target_row, target_col + 16) if cell_value(worksheet, target_row, target_col + 16) != "" else None,
                                     ...
                                     cell_value(worksheet, target_row, target_col + 29) if cell_value(worksheet, target_row, target_col + 29) != "" else None,
                                     cell_value(worksheet, target_row, target_col + 30) if cell_value(worksheet, target_row, target_col + 30) != "" else None,
