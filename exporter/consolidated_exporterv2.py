...
class ConsolidatedExporter:
    ...
    def __write_headers(self, sheet):
        ...
        worksheet.merge_range('A1:A3', 'Stock Code', merge_format)
        worksheet.merge_range('B1:B3', 'Direction', merge_format)
        worksheet.merge_range('C1:C3', 'Current Size', merge_format)
        worksheet.merge_range('D1:D3', 'Scenario',merge_format)
        worksheet.merge_range('E1:E3', 'Last Updated', merge_format)
        worksheet.merge_range('F1:F3', 'FD shares(m)', merge_format)
        worksheet.merge_range('G1:G3', 'Market Cap', merge_format)
        worksheet.merge_range('H1:H3', 'Best Model', merge_format)
        worksheet.merge_range('I1:I3', 'Best Research', merge_format)
        worksheet.merge_range('J1:J3', 'AV Theme', merge_format)
        worksheet.merge_range('K1:K3', 'Sub Theme', merge_format)
        worksheet.merge_range('L1:L3', 'Asia Angle', merge_format)

        # Short Metrics
        worksheet.merge_range('M1:Q1', 'Short Metrics', merge_format)
        worksheet.merge_range('M2:M3', 'Borrow Cost', merge_format)
        worksheet.merge_range('N2:N3', 'SI (m shares)', merge_format)
        worksheet.merge_range('O2:O3', 'SIR (Bberg)', merge_format)
        worksheet.merge_range('P2:P3', 'SIR (Calc)', merge_format)
        worksheet.merge_range('Q2:Q3', 'SI as of FF', merge_format)

        # IRR Decomp
        worksheet.merge_range('R1:U1', 'IRR Decomp', merge_format)
        worksheet.merge_range('R2:R3', 'IRR Target %', merge_format)
        worksheet.merge_range('S2:S3', 'EPS Growth', merge_format)
        worksheet.merge_range('T2:T3', 'Yield', merge_format)
        worksheet.merge_range('U2:U3', 'Multiple Expansion', merge_format)

        #Current Valuation
        worksheet.merge_range('V1:BE1', 'Current Valuation', merge_format)
        worksheet.merge_range('R2:R3', 'IRR Target %', merge_format)
        worksheet.merge_range('S2:S3', 'EPS Growth', merge_format)
        worksheet.merge_range('T2:T3', 'Yield', merge_format)
        worksheet.merge_range('U2:U3', 'Multiple Expansion', merge_format)
        ...
        worksheet.merge_range('M2:Q1', 'Short Metrics', merge_format)

        worksheet.write('M1', 'PT (Base)', merge_format)
