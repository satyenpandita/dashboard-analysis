...
def write_data2(workbook, data, sheet):
    ...
    for idx, dashboard in enumerate(data):
        ...
        if not dsh.old:
            ...
            worksheet.write('C{}'.format(count+offset), get_val(implied_multiple, 'ev_per_gross_revenue', 'pt_bear', 'current_year'))
            worksheet.write('D{}'.format(count+offset), get_val(implied_multiple, 'ev_per_gross_revenue', 'pt_base', 'current_year'))
            worksheet.write('E{}'.format(count+offset), get_val(implied_multiple, 'ev_per_gross_revenue', 'pt_bull', 'current_year'))
            worksheet.write('F{}'.format(count+offset), get_val(implied_multiple, 'ev_per_net_revenue', 'pt_bear', 'current_year'))
            worksheet.write('G{}'.format(count+offset), get_val(implied_multiple, 'ev_per_net_revenue', 'pt_bear', 'current_year'))
            worksheet.write('H{}'.format(count+offset), get_val(implied_multiple, 'ev_per_net_revenue', 'pt_bear', 'current_year'))
            worksheet.write('I{}'.format(count+offset), get_val(implied_multiple, 'ev_per_nii', 'pt_bear', 'current_year'))
            worksheet.write('J{}'.format(count+offset), get_val(implied_multiple, 'ev_per_nii', 'pt_base', 'current_year'))
            worksheet.write('K{}'.format(count+offset), get_val(implied_multiple, 'ev_per_nii', 'pt_bull', 'current_year'))
            worksheet.write('L{}'.format(count+offset), get_val(implied_multiple, 'ev_per_gmv', 'pt_bear', 'current_year'))
            worksheet.write('M{}'.format(count+offset), get_val(implied_multiple, 'ev_per_gmv', 'pt_base', 'current_year'))
            worksheet.write('N{}'.format(count+offset), get_val(implied_multiple, 'ev_per_gmv', 'pt_bull', 'current_year'))
            worksheet.write('O{}'.format(count+offset), get_val(implied_multiple, 'ev_per_adj_ebidta', 'pt_bear', 'current_year'))
            worksheet.write('P{}'.format(count+offset), get_val(implied_multiple, 'ev_per_adj_ebidta', 'pt_base', 'current_year'))
            worksheet.write('Q{}'.format(count+offset), get_val(implied_multiple, 'ev_per_adj_ebidta', 'pt_bull', 'current_year'))
            worksheet.write('R{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebidtar', 'pt_bear', 'current_year'))
            worksheet.write('S{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebidtar', 'pt_base', 'current_year'))
            worksheet.write('T{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebidtar', 'pt_bull', 'current_year'))
            worksheet.write('U{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebita', 'pt_bear', 'current_year'))
            worksheet.write('V{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebita', 'pt_base', 'current_year'))
            worksheet.write('W{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebita', 'pt_bear', 'current_year'))
            worksheet.write('X{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebit', 'pt_bear', 'current_year'))
            worksheet.write('Y{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebit', 'pt_base', 'current_year'))
            worksheet.write('Z{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebit', 'pt_bull', 'current_year'))
            worksheet.write('AA{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ppop', 'pt_bear', 'current_year'))
            worksheet.write('AB{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ppop', 'pt_base', 'current_year'))
            worksheet.write('AC{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ppop', 'pt_bull', 'current_year'))
            worksheet.write('AD{}'.format(count+offset), get_val(implied_multiple, 'adj_eps', 'pt_bear', 'current_year'))
            worksheet.write('AE{}'.format(count+offset), get_val(implied_multiple, 'adj_eps', 'pt_base', 'current_year'))
            worksheet.write('AF{}'.format(count+offset), get_val(implied_multiple, 'adj_eps', 'pt_bull', 'current_year'))
            worksheet.write('AG{}'.format(count+offset), get_val(implied_multiple, 'fcf_per_p', 'pt_bear', 'current_year'))
            worksheet.write('AH{}'.format(count+offset), get_val(implied_multiple, 'fcf_per_p', 'pt_base', 'current_year'))
            worksheet.write('AI{}'.format(count+offset), get_val(implied_multiple, 'fcf_per_p', 'pt_bull', 'current_year'))
            worksheet.write('AJ{}'.format(count+offset), get_val(implied_multiple, 'cfcf_per_p', 'pt_bear', 'current_year'))
            worksheet.write('AK{}'.format(count+offset), get_val(implied_multiple, 'cfcf_per_p', 'pt_base', 'current_year'))
            worksheet.write('AL{}'.format(count+offset), get_val(implied_multiple, 'cfcf_per_p', 'pt_bull', 'current_year'))
            worksheet.write('AM{}'.format(count+offset), get_val(implied_multiple, 'ev_per_gross_revenue', 'pt_bear', 'current_year_plus_three'))
            worksheet.write('AN{}'.format(count+offset), get_val(implied_multiple, 'ev_per_gross_revenue', 'pt_base', 'current_year_plus_three'))
            worksheet.write('AO{}'.format(count+offset), get_val(implied_multiple, 'ev_per_gross_revenue', 'pt_bull', 'current_year_plus_three'))
            worksheet.write('AP{}'.format(count+offset), get_val(implied_multiple, 'ev_per_net_revenue', 'pt_bear', 'current_year_plus_three'))
            worksheet.write('AQ{}'.format(count+offset), get_val(implied_multiple, 'ev_per_net_revenue', 'pt_base', 'current_year_plus_three'))
            worksheet.write('AR{}'.format(count+offset), get_val(implied_multiple, 'ev_per_net_revenue', 'pt_bull', 'current_year_plus_three'))
            worksheet.write('AS{}'.format(count+offset), get_val(implied_multiple, 'ev_per_nii', 'pt_bear', 'current_year_plus_three'))
            worksheet.write('AT{}'.format(count+offset), get_val(implied_multiple, 'ev_per_nii', 'pt_base', 'current_year_plus_three'))
            worksheet.write('AU{}'.format(count+offset), get_val(implied_multiple, 'ev_per_nii', 'pt_bull', 'current_year_plus_three'))
            worksheet.write('AV{}'.format(count+offset), get_val(implied_multiple, 'ev_per_gmv', 'pt_bear', 'current_year_plus_three'))
            worksheet.write('AW{}'.format(count+offset), get_val(implied_multiple, 'ev_per_gmv', 'pt_base', 'current_year_plus_three'))
            worksheet.write('AX{}'.format(count+offset), get_val(implied_multiple, 'ev_per_gmv', 'pt_bull', 'current_year_plus_three'))
            worksheet.write('AY{}'.format(count+offset), get_val(implied_multiple, 'ev_per_adj_ebidta', 'pt_bear', 'current_year_plus_three'))
            worksheet.write('AZ{}'.format(count+offset), get_val(implied_multiple, 'ev_per_adj_ebidta', 'pt_base', 'current_year_plus_three'))
            worksheet.write('BA{}'.format(count+offset), get_val(implied_multiple, 'ev_per_adj_ebidta', 'pt_bull', 'current_year_plus_three'))
            worksheet.write('BB{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebidtar', 'pt_bear', 'current_year_plus_three'))
            worksheet.write('BC{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebidtar', 'pt_base', 'current_year_plus_three'))
            worksheet.write('BD{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebidtar', 'pt_bull', 'current_year_plus_three'))
            worksheet.write('BE{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebita', 'pt_bear', 'current_year_plus_three'))
            worksheet.write('BF{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebita', 'pt_base', 'current_year_plus_three'))
            worksheet.write('BG{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebita', 'pt_bull', 'current_year_plus_three'))
            worksheet.write('BH{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebit', 'pt_bear', 'current_year_plus_three'))
            worksheet.write('BI{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebit', 'pt_base', 'current_year_plus_three'))
            worksheet.write('BJ{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ebit', 'pt_bull', 'current_year_plus_three'))
            worksheet.write('BK{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ppop', 'pt_bear', 'current_year_plus_three'))
            worksheet.write('BL{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ppop', 'pt_base', 'current_year_plus_three'))
            worksheet.write('BM{}'.format(count+offset), get_val(implied_multiple, 'ev_per_ppop', 'pt_bull', 'current_year_plus_three'))
            worksheet.write('BN{}'.format(count+offset), get_val(implied_multiple, 'adj_eps', 'pt_bear', 'current_year_plus_three'))
            worksheet.write('BO{}'.format(count+offset), get_val(implied_multiple, 'adj_eps', 'pt_base', 'current_year_plus_three'))
            worksheet.write('BP{}'.format(count+offset), get_val(implied_multiple, 'adj_eps', 'pt_bull', 'current_year_plus_three'))
            worksheet.write('BQ{}'.format(count+offset), get_val(implied_multiple, 'fcf_per_p', 'pt_bear', 'current_year_plus_three'))
            worksheet.write('BR{}'.format(count+offset), get_val(implied_multiple, 'fcf_per_p', 'pt_base', 'current_year_plus_three'))
            worksheet.write('BS{}'.format(count+offset), get_val(implied_multiple, 'fcf_per_p', 'pt_bull', 'current_year_plus_three'))
