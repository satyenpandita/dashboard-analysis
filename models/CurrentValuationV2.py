...
class CurrentValuationV2(object):
    ...
    FCF_CHOICES = ['Free Cash Flow / P - AIM', 'Core Free Cash Flow / P - AIM', 'EV/uFCF - AIM',
    ...
    def __init__(self, worksheet):
        ...
        if cell_address:
            ...
            if metric == CurrentValuationV2.FCF_CHOICES[0]:
                ...
                self.ev_ufcf = get_object(worksheet, row + 11, col)
            elif metric == CurrentValuationV2.FCF_CHOICES[1]:
                self.free_surpus_price = get_object(worksheet, row + 11, col)
